...
let AuthService = class AuthService {
    ...
    bcrypt;
    jwt;
    constructor(usuarioService, bcrypt, jwt) {
    ...
    async validarUser(usuario, senha) {
        ...
        if (compararSenha)
            throw new common_1.UnauthorizedException("usuario ou senha não correspondem");
...
exports.AuthService = AuthService = __decorate([
    ...
    __metadata("design:paramtypes", [usuario_service_1.usuarioService, bcrypt_1.Bcrypt, jwt_1.JwtService])
], AuthService);
